...
function Button() {
  return (
    <div className="main1">
        ...
        <div className="up1">
        <button className="card11" onClick={() => window.location.href = 'https://www.instagram.com/creator__79/'}>
          ...
          <button className="card12" onClick={() => window.location.href = 'https://twitter.com/creator_79/'}>
        ...
        <div className="down1">
        <button className="card13" onClick={() => window.location.href = 'https://github.com/creator79'}>
          ...
          <button className="card14" onClick={() => window.location.href = 'https://discord.com/channels/1087815091979821127/1087815092705431678'}>
        ...
        <span>
        <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=32&pause=1000&color=DA931E&center=true&vCenter=true&width=500&lines=This+Is+My+Social+Links+!;Twitter+;Github;Instagram;Discord" alt="Typing SVG" /></a>
        </span>
...
export default SectionWrapper(Button, "button");
